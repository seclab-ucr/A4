...
class AdGraph
{
  public:
    ...
    AdGraphAPI::HTTPNode* CreateAndReturnHTTPNode(std::string id, bool script_is_active, std::string active_script_id, std::string url, bool ad); 
    ...
    void AddEdge(std::string source_id, std::string target_id);
  ...
  protected:
    ...
    std::vector<std::pair<std::string, std::string>> edge_list_;
